...
import bonus4Img from "@/assets/marmoraria-bonus-4.jpg";
import garantiaAsset from "@/assets/garantia-30-dias.png";
import depo1 from "@/assets/depo-marmorista-1.jpg";
import depo2 from "@/assets/depo-marmorista-2.jpg";
import depo3 from "@/assets/depo-marmorista-3.jpg";
...
function HowYouGet() {
  const steps = [
    ...
    { icon: "✅", t: "É só usar — funciona na marmoraria, mesmo sem sinal de internet" },
  ];
...
function Pains() {
  const items = [
    {
      icon: "🧮",
      t: "Gasta uma hora calculando chapa, corte e acabamento que o app faria em 2 minutos — e ainda erra a conta",
    },
    {
      icon: "🛒",
      t: "Orça no chute, começa o serviço e descobre que faltou material — compra na loja pagando 2x o preço",
    },
    {
      icon: "💬",
      t: 'Responde "te mando o valor depois" e o cliente já fechou com outro marmorista que respondeu PDF em 5 minutos',
    },
    {
      icon: "🏃",
      t: "Perde serviço para marmorista menos experiente só porque ele responde mais rápido e com proposta profissional",
    },
    {
      icon: "📉",
      t: "Termina o serviço e descobre que o lucro sumiu porque não calculou direito a metragem da chapa",
    },
  ];
  return (
  ...
  const steps = [
    {
      ...
      desc: "Preencha cliente, tipo de serviço (bancada, piso, soleira...), metragem em m² e sua margem de lucro direto no celular.",
    },
    {
      n: "2",
      img: appCustos,
      title: "CÁLCULO AUTOMÁTICO",
      desc: "O app calcula chapa, corte, acabamento, mão de obra, total a cobrar e seu lucro líquido na hora.",
    },
    {
      n: "3",
      img: appResultado,
  ...
  return (
    <section style={{ background: C.navyDeep, padding: "80px 20px" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          O QUE É O <span style={{ color: C.yellow }}>ORÇAMARMORARIA PRO</span>
        </h2>
...
function Included() {
  const items = [
    "Cálculo automático de chapa, corte e acabamento para 8 tipos de serviço",
    ...
    "Funciona offline no celular, tablet ou computador — direto na marmoraria",
...
function Bonuses() {
  const items = [
    { title: 'Curso "Marmorista que Fecha"', img: bonus1Img, value: "R$ 37,00" },
    { title: '"Medição que Convence em 1 Hora"', img: bonus2Img, value: "R$ 37,00" },
    { title: 'Kit "Marmorista Profissional" para Fechar Serviço no WhatsApp', img: bonus3Img, value: "R$ 37,00" },
        ...
        >
          ...
          >
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "28px 0 0", display: "grid", gap: 12 }}>
              {[
                { ok: true, t: "App OrçaMarmoraria Pro" },
          ...
          >
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "28px 0 0", display: "grid", gap: 11 }}>
              ...
              {[
                "BÔNUS: Curso Marmorista que Fecha",
                "BÔNUS: Medição que Convence em 1 Hora",
                "BÔNUS: Kit Marmorista Profissional",
  ...
  const testimonials = [
    {
      name: "Cláudio Mendes",
      city: "Guarulhos - SP",
      role: "Bancadas de granito",
      text: "Antes eu levava meio dia pra fechar um orçamento de bancada e ainda perdia o cliente. Agora mando o PDF em 3 minutos pelo Whats e o cara aprova na hora. Fechei 4 serviços a mais só essa semana.",
    },
    {
      name: "Rogério Alves",
      city: "Contagem - MG",
      role: "Cozinhas em granito",
      text: "Eu orçava no chute e vivia comprando chapa a mais na loja pagando o dobro. O app calcula chapa, corte e acabamento certinho. Parei de perder dinheiro com material.",
    },
    {
      name: "Fábio Souza",
      city: "Curitiba - PR",
      role: "Bancadas de banheiro",
    ...
    },
    {
      ...
      role: "Marmoraria geral",
      text: "Cansei de terminar serviço e ver que o lucro tinha sumido. O app mostra o lucro líquido antes de eu passar o preço. Agora sei exatamente quanto vou ganhar em cada serviço.",
    },
    {
      name: "Wagner Costa",
      city: "Feira de Santana - BA",
      role: "Soleiras e peitoris",
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 280 }}>
          ...
          <p style={{ color: C.inkSoft, fontSize: 15, lineHeight: 1.6, margin: 0 }}>
            Teste o <strong style={{ color: C.ink }}>OrçaMarmoraria Pro</strong> sem pressa.
            Se em 30 dias você achar que não serve pra sua marmoraria — sem burocracia, sem perguntar nada,
    ...
    <section style={{ background: C.cream, padding: "60px 20px 80px" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ textAlign: "center" }}>
          ...
          >
            QUEM CRIOU O <span style={{ color: C.yellowDeep }}>ORÇAMARMORARIA PRO?</span>
          </h2>
        </div>
        ...
        >
          ...
          >
            <img
              src={criadorImg}
              alt="Carlos Eduardo - Marmorista autônomo há +14 anos"
            ...
            >
              ...
              <div style={{ ...heading, color: C.yellow, fontSize: 11, letterSpacing: 1.5, marginTop: 4 }}>
                MARMORISTA AUTÔNOMO HÁ +14 ANOS
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p style={{ color: C.inkSoft, fontSize: 15, lineHeight: 1.7, marginTop: 20 }}>
              Trabalho com marmoraria desde os 20 anos. Sempre gostei do serviço, mas odiava a parte de
              orçar. Ficava com papel e calculadora tentando somar chapa, corte, acabamento e mão de obra — e volta e
            ...
            <p style={{ color: C.inkSoft, fontSize: 15, lineHeight: 1.7, marginTop: 14 }}>
              ...
              marmorista que respondia mais rápido. Perdi muito serviço bom só por não ter uma proposta pronta na hora.
            </p>
            <p style={{ color: C.inkSoft, fontSize: 15, lineHeight: 1.7, marginTop: 14 }}>
              Foi por isso que criei o <strong style={{ color: C.ink }}>OrçaMarmoraria Pro</strong> — um app simples
              que calcula toda a chapa, corte, acabamento e a mão de obra em segundos e gera um PDF profissional pra mandar no
...
function FAQ() {
  const items = [
    ...
    },
    {
      ...
      a: "Não. O app é PWA e funciona 100% offline. Você monta o orçamento direto na marmoraria, sem depender de sinal. Quando voltar pra área com internet, ele sincroniza sozinho.",
    },
    {
      q: "Preciso entender de planilha ou cálculo?",
      a: "Não. Foi feito pra marmorista que não gosta de planilha. Você só escolhe o tipo de serviço, informa a metragem e a margem — o app calcula chapa, corte, acabamento, mão de obra e o total sozinho.",
    },
    {
    ...
    },
    {
      ...
      a: "Sim. Tem um editor de preços onde você coloca os valores do SEU fornecedor de chapa, corte e acabamento. Assim o orçamento sai sempre com o preço real da sua região, sem tabela defasada.",
    },
    {
