/**
 * Landing Page Configuration — OrçaMarmoraria Pro (marmoristas autônomos)
 */

export const CONFIG = {
  brand: {
    name: "OrçaMarmoraria Pro",
    shortName: "OrçaMarmoraria",
    tagline: "FEITO PARA MARMORISTAS",
    socialProofCount: "+1.000",
  },

  checkout: {
    basic: "https://pay.wiapy.com/ODq7rFssa-S",
    premium: "https://pay.wiapy.com/Boz1-Rig5wG0",
  },
  ...
  hero: {
    badge: "🪨 FEITO PARA MARMORISTAS",
    subheadline:
      "Gere PDF profissional e personalizado com o OrçaMarmoraria Pro em minutos e feche mais serviços.",
    socialProofCount: "+1.000",
    socialProofLabel: "MARMORISTAS JÁ USAM",
    ctaScrollLabel: "QUERO MEU ACESSO AGORA  →",
  },

  finalCta: {
    body: "Enquanto você lê isso, tem um marmorista que já mandou o PDF. Por menos de R$25 você nunca mais perde serviço por demora.",
  ...
  salesPopup: {
    ...
    sales: [
      ...
      { name: "Eduardo", city: "Campinas - SP", time: "há 28 minutos" },
